...
public interface ClientProperties {
    ...
    public static final String INPUT_TAKECOURSE_MSG = "수강한 강좌의 ID를 입력하세요 ('/'로 구분. 예시: 1010/1011 ) :";
    public static final String REGISTER_COURSE_STDID = "수강신청을 진행할 학생의 ID를 입력하세요 :";
    public static final String REGISTER_COURSE_COURSEID = "수강신청할 과목의 ID를 입력하세요 ('/'로 구분. 예시: 1010/1011 ) :";
